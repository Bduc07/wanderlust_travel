...
export class MemStorage implements IStorage {
  ...
  async updatePackage(id: number, pkg: InsertPackage): Promise<Package> {
    const updatedPackage: Package = { ...pkg, id };
  ...
  async createOffer(offer: InsertSpecialOffer): Promise<SpecialOffer> {
    ...
    const newOffer: SpecialOffer = { ...offer, id };
  ...
  private initializeSampleData() {
    ...
    const adminUser: User = {
      ...
      password: "$2b$10$CwTycUXWue0Thq9StjUM0uQxTmPDkWM3AF/F6jLmU9SH6wPtHFM8K", // password: admin123
      role: "admin"
    };
        ...
        itinerary: [
          {
            ...
            description: "Arrival at Santorini Airport and transfer to your hotel in Fira. Evening welcome dinner with local specialties and orientation briefing."
          },
          {
            title: "Fira & Firostefani Exploration",
            description: "Morning walking tour of Fira, the island's capital. Continue to neighboring Firostefani for stunning caldera views. Afternoon at leisure to explore the winding streets and boutique shops."
          },
          {
            title: "Ancient Akrotiri & Beach Time",
            description: "Morning visit to the archaeological site of Akrotiri, a Minoan Bronze Age settlement. Afternoon relaxation at Kamari black sand beach with optional water activities."
          },
          {
            title: "Wine & Culture Experience",
            description: "Visit traditional wineries and taste the unique volcanic wines of Santorini. Afternoon visit to a local art gallery and traditional crafts workshop."
          },
          {
            title: "Caldera Cruise",
            description: "Full-day catamaran cruise around the caldera, visiting hot springs, red beach, and white beach with opportunities for swimming and snorkeling. BBQ lunch onboard."
          },
          {
            title: "Oia & Sunset Experience",
            description: "Morning at leisure. Afternoon transfer to the picturesque village of Oia with its blue-domed churches and winding alleys. Farewell dinner at a cliff-side restaurant while watching the world-famous Santorini sunset."
          },
          {
            title: "Departure Day",
            description: "After breakfast, transfer to Santorini Airport for your departure flight."
          }
        ],
        gallery: [
        ...
        itinerary: [
          {
            ...
            description: "Welcome to Bali! Upon arrival at Ngurah Rai International Airport, transfer to your hotel in Seminyak. Rest of the day at leisure to recover from your flight and enjoy the hotel facilities."
          },
          {
            title: "Seminyak Beach & Sunset",
            description: "Morning at leisure to enjoy Seminyak's beaches. Afternoon shopping tour through stylish boutiques. Evening sunset dinner at a renowned beach club with spectacular ocean views."
          },
          {
            title: "Journey to Ubud",
            description: "After breakfast, transfer to Ubud. En route, visit Batuan Temple and a traditional art village. Afternoon check-in at your Ubud resort surrounded by lush jungle."
          },
          {
            title: "Ubud Cultural Immersion",
            description: "Morning visit to the Sacred Monkey Forest and Ubud Palace. Afternoon traditional craft workshop where you'll try your hand at batik making or wood carving. Evening traditional dance performance."
          },
          {
            title: "Tegalalang & Cooking Class",
            description: "Morning visit to the stunning Tegalalang Rice Terraces. Afternoon authentic Balinese cooking class where you'll learn to prepare local specialties, followed by dinner enjoying your creations."
          },
          {
            title: "Mount Batur Sunrise Trek",
            description: "Optional early morning trek to Mount Batur to witness a spectacular sunrise (additional cost). Afternoon visit to coffee plantation and holy water temple of Tirta Empul."
          },
          {
            title: "Transfer to Nusa Dua",
            description: "Morning transfer to the luxury beach area of Nusa Dua. En route, visit the dramatic Tegenungan Waterfall. Evening at leisure at your beachfront resort."
          },
          {
            title: "Nusa Penida Island Excursion",
            description: "Full-day boat trip to Nusa Penida Island. Visit the iconic Kelingking Beach, Angel's Billabong, and Broken Beach. Snorkeling opportunity at Crystal Bay to see vibrant marine life."
          },
          {
            title: "Temple & Cultural Tour",
            description: "Morning visit to the seaside Tanah Lot Temple. Afternoon tour of Uluwatu Temple perched on dramatic cliffs, followed by traditional Kecak fire dance performance at sunset."
          },
          {
            title: "Departure Day",
            description: "Free time until your airport transfer for your departure flight. Optional spa treatment can be arranged (additional cost)."
          }
        ],
        gallery: [
        ...
        itinerary: [
          {
            ...
            description: "Arrive at Tokyo Narita or Haneda Airport and transfer to your centrally located hotel. Evening welcome dinner featuring authentic Japanese cuisine and orientation briefing."
          },
          {
            title: "Tokyo Exploration",
            description: "Full day exploring Tokyo's highlights: Meiji Shrine, Harajuku's trendy Takeshita Street, serene Shinjuku Gyoen National Garden, and the famous Shibuya Crossing. Evening visit to Tokyo Skytree for panoramic night views."
          },
          {
            title: "Tokyo Cultural Immersion",
            description: "Morning visit to Tsukiji Outer Market for a taste of Japan's food culture. Afternoon boat cruise on the Sumida River, followed by exploration of traditional Asakusa district and the ancient Senso-ji Temple."
          },
          {
            title: "Mount Fuji Excursion",
            description: "Day trip to the Mount Fuji area. Visit the 5th Station (weather permitting), cruise on Lake Ashi, and ride the Hakone Ropeway for breathtaking views. Return to Tokyo in the evening."
          },
          {
            title: "Tokyo to Kyoto",
            description: "Morning bullet train (Shinkansen) to Kyoto. Afternoon visit to Nijo Castle with its 'nightingale floors' and the spectacular golden Kinkaku-ji (Golden Pavilion)."
          },
          {
            title: "Kyoto's Ancient Treasures",
            description: "Full day exploring Kyoto's UNESCO World Heritage sites: Fushimi Inari Shrine with its thousands of vermilion torii gates, the zen rock garden at Ryoan-ji Temple, and a traditional tea ceremony experience."
          },
          {
            title: "Arashiyama & Gion District",
            description: "Morning visit to the bamboo grove and temples of Arashiyama. Afternoon walking tour of the preserved historic district of Higashiyama. Evening guided walk through Gion with the possibility of spotting geisha on their way to appointments."
          },
          {
            title: "Departure Day",
            description: "After breakfast, transfer to Kansai International Airport for your departure flight or extend your stay in Japan."
          }
        ],
        gallery: [
        ...
        itinerary: [
          {
            ...
            description: "Arrive in Lima, Peru's capital. Transfer to your hotel in the Miraflores district. Evening welcome dinner at a renowned Peruvian restaurant featuring diverse regional cuisines."
          },
          {
            title: "Lima City Tour & Flight to Cusco",
            description: "Morning exploration of Lima's historic center, a UNESCO World Heritage site. Afternoon flight to Cusco. Evening at leisure to acclimate to the altitude (11,152 ft)."
          },
          {
            title: "Cusco & Sacred Valley",
            description: "Morning visit to Sacsayhuaman fortress overlooking Cusco. Afternoon excursion to the Sacred Valley, visiting the Pisac ruins and traditional market. Overnight in Ollantaytambo, exploring this living Inca town."
          },
          {
            title: "Inca Trail Day 1: Km 82 to Huayllabamba",
            description: "Early transfer to Km 82, the starting point of the Inca Trail. Hike through the Urubamba Valley, visiting the Llactapata archaeological site. Overnight camp at Huayllabamba (9,842 ft)."
          },
          {
            title: "Inca Trail Day 2: Dead Woman's Pass",
            description: "The most challenging day, climbing to Dead Woman's Pass (13,829 ft), the highest point of the trail. Descend to Pacaymayu Valley for overnight camping. Spectacular mountain views throughout."
          },
          {
            title: "Inca Trail Day 3: Cloud Forest & Inca Ruins",
            description: "Hike through beautiful cloud forest and visit several impressive Inca sites: Runkurakay, Sayacmarca, and Phuyupatamarca. Camp at Wiñay Wayna with its extensive terraces and ritual baths."
          },
          {
            title: "Inca Trail Day 4: Machu Picchu",
            description: "Early morning hike to Inti Punku (Sun Gate) for sunrise over Machu Picchu. Guided tour of the citadel, exploring temples, plazas, and residential areas. Afternoon train to Aguas Calientes for overnight hotel stay."
          },
          {
            title: "Machu Picchu (Optional Second Visit) & Return to Cusco",
            description: "Optional second entry to Machu Picchu (additional cost) to explore areas like Huayna Picchu. Afternoon train and transfer back to Cusco. Evening farewell dinner featuring traditional music and dance."
          },
          {
            title: "Departure Day",
            description: "Morning flight from Cusco to Lima, connecting with your international departure flight."
          }
        ],
        gallery: [
        ...
        itinerary: [
          {
            ...
            description: "Arrive in Istanbul, the city straddling two continents. Transfer to your hotel in the historic Sultanahmet district. Evening welcome dinner featuring traditional Turkish cuisine with views of the illuminated city."
          },
          {
            title: "Istanbul Historical Tour",
            description: "Full day exploring Istanbul's UNESCO-listed sites: the magnificent Blue Mosque with its six minarets, the 1,500-year-old Hagia Sophia, Topkapi Palace with its imperial treasures, and the underground Basilica Cistern. End the day at the Grand Bazaar, one of the world's oldest and largest covered markets."
          },
          {
            title: "Bosphorus Cruise & Modern Istanbul",
            description: "Morning cruise along the Bosphorus Strait, viewing Ottoman palaces and wooden villas. Afternoon visit to the Spice Bazaar followed by exploration of modern Istanbul: Istiklal Street, Galata Tower, and the trendy Karakoy district."
          },
          {
            title: "Flight to Cappadocia",
            description: "Morning flight to Kayseri/Nevsehir. Transfer to your unique cave hotel in Cappadocia. Afternoon visit to Goreme Open Air Museum with its rock-cut churches and Byzantine frescoes. Evening traditional Turkish folk dance show with dinner."
          },
          {
            title: "Cappadocia Hot Air Balloon & Exploration",
            description: "Pre-dawn departure for a magical hot air balloon ride over Cappadocia's fairy chimneys at sunrise (weather permitting). After breakfast, explore the underground city of Derinkuyu, Pasabag Valley, and visit a local pottery workshop in Avanos."
          },
          {
            title: "Red Valley Hike & Local Experience",
            description: "Morning hike through the scenic Red Valley with its striking rock formations. Afternoon cooking class learning to prepare traditional Turkish dishes, followed by a visit to a local family's home for tea."
          },
          {
            title: "Return to Istanbul",
            description: "Morning flight back to Istanbul. Afternoon visit to Dolmabahce Palace, the last residence of Ottoman sultans, and exploration of the Ortakoy neighborhood with its vibrant waterfront scene. Evening at leisure for personal discoveries."
          },
          {
            title: "Departure Day",
            description: "After breakfast, transfer to Istanbul International Airport for your departure flight, or extend your stay in Turkey."
          }
        ],
        gallery: [
        ...
        itinerary: [
          {
            ...
            description: "Arrive at Malé International Airport where you'll be greeted and escorted to the seaplane terminal. Enjoy refreshments in the private lounge before your scenic seaplane flight to the resort. Upon arrival, receive a warm welcome with cold towels and tropical drinks. After check-in to your overwater villa, enjoy the rest of the day at leisure, perhaps with a swim in your private infinity pool overlooking the ocean."
          },
          {
          ...
          },
          {
            ...
            description: "Breakfast at leisure. Final morning to enjoy your villa and the resort facilities. Private beach farewell lunch. Afternoon seaplane transfer to Malé International Airport for your departure flight."
          }
        ],
        gallery: [
    ...
    const destinations: InsertDestination[] = [
      {
        name: "Paris",
        country: "France",
        image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=800",
        tourCount: 124,
        featured: true
      },
      {
        ...
        image: "https://pixabay.com/get/ge50ebababd575d8ff8a41cbac30781f54e6426b733621789ec74c028d6b0ae2ee2489c2f4feb39d53339265e0addc360cf81d46322bbc758c52bfa5c3399926a_1280.jpg",
        tourCount: 86,
        featured: true
      },
      {
        name: "Rome",
        country: "Italy",
        image: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=800",
        tourCount: 108,
        featured: true
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=800",
        tourCount: 96,
        featured: true
      },
      {
        name: "Rio de Janeiro",
        country: "Brazil",
        image: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&h=600",
        tourCount: 74,
        featured: true
      },
      {
        name: "Sydney",
        country: "Australia",
        image: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&h=600",
        tourCount: 82,
        featured: true
      }
    ];
